...
exports.clients = {
  ...
  NoirShares : new bitcoin.Client(config.deposits.bitcoin),
  Noirbits: new bitcoin.Client(config.deposits.dogecoin),
  NoirTokens : new bitcoin.Client(config.deposits.litecoin),
